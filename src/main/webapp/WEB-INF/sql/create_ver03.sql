...
create table MEMBER ( /* 회원정보 */
   ...
   MEMBER_PHONE VARCHAR2(14) not null, /* 전화번호 */
...
create table PROJECT ( /* 프로젝트 */
   ...
   PROJECT_SUB VARCHAR2(400) not null, /* 프로젝트제목 */
   ...
   MEMBER_ID VARCHAR2(50) not null,/* 작성자 id */
   PROJECT_THUMBNAIL VARCHAR2(200) not null, /* 프로젝트썸네일 */
...
create table QNA   ( /* 질문게시판 */
   ...
   QNA_CON VARCHAR2(700) not null, /* 질문 내용 */
...
create table QNA_REPLY  ( /* 질문게시판댓글 */
   ...
   QNA_NUM NUMBER not null, /* 번호 */
   QNA_RE_CON VARCHAR2(700) not null, /* 내용 */
   QNA_RE_DATE DATE DEFAULT SYSDATE, /* 작성일 */
   QNA_RE_NAME VARCHAR2(50) not null, /* 작성자 */
...
create table NOTICE  ( /* 공지사항 */
   ...
   NOTICE_VIEW NUMBER default 0 not null /* 조회수 */
);
...
-- 2022-04-06 
-- 프로젝트 T / PROJECT_THUMBNAIL 칼럼 추가